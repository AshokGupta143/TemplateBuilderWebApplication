...
export const builderActions = {
  ...
  getXML: () => {
	...
	console.log($('.build-wrap').formBuilder('getData', 'html'))
  },
  getJSON: () => {
  ...
  loadUserForm: () => {
    ...
    $('.build-wrap').formBuilder(formRenderOptions)
  },
}
...
export const renderActions = {
  ...
  getHTML: () => {
	...
	const formdata = $('.render-wrap').formRender('html')
	 window.sessionStorage.setItem('couchdata', formdata)
  },
  showUserData: () => {
